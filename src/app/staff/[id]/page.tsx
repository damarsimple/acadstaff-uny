...
import { Email, EmailSharp, Facebook, Instagram, LinkOutlined, LinkedIn, LocalPostOffice, Place, YouTube } from '@mui/icons-material'
import { Avatar, Box, Breadcrumbs, Button, Link, Paper, Typography } from '@mui/material'
...
async function getStaffData(email: string) {
    ...
    const { data } = await client.query({
        query: gql`query FindUniqueAcademicStaff($where: AcademicStaffWhereUniqueInput!) {
        ...
        <Box sx={{
            ...
            <Box sx={{
                ...
                <Paper sx={{
                    ...
                    <Avatar
                        src={
                            staff.profile_image_url ?? "/bg.jpeg"
                        }
                        sx={{
                            width: 160,
                            height: 160
